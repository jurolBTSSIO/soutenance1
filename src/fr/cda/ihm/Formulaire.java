...
/**
   Classe de definition d'un formulaire JAVA permettant de faire �
...
public class Formulaire
{
    ...
    */
    ...
    /** Methode qui ajoute un canvas de grille
        ...
        @param controle objet dont la classe surcharge les m�thodes de l'interface ControlesCanvasIHM. Il permet de realiser les actions realis�es dans la grille.
     */
...
// Classe non inner-class car utilisee dans une m�thode statique.
