...
/**
   Classe de definition d'un formulaire JAVA permettant de faire à
...
public class Formulaire
{
    ...
    */
    ...
    /** Methode qui ajoute un canvas de grille
        ...
        @param controle objet dont la classe surcharge les méthodes de l'interface ControlesCanvasIHM. Il permet de realiser les actions realisées dans la grille.
     */
...
// Classe non inner-class car utilisee dans une méthode statique.
